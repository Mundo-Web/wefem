                    ...
                    <div class="rounded shadow-lg p-4 px-4 ">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            ...
                            <div class="md:col-span-3">
                                <label for="name">Nombre y Apellido de usuario</label>
                            ...
                            <div class="md:col-span-5">
                                <label for="testimonie">Comentario <span class="text-red-600">(Escribe entre (*) las
                                        palabras que quiere resaltar del testimonio)</span></label>
                                <div class="relative mb-2 mt-2">
                                    <div
                                    ...
                                    <textarea type="text" rows="2" id="testimonie" name="testimonie" value=""
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Ej. *Escribe aqui*..."></textarea>
                                </div>
                            </div>


                            <div class="md:col-span-5">
                                <label for="imagen">Subir imagen - Se aceptan formato .png/.jpg/.webp (380x540 px)
                                </label>
                                <div class="relative mb-2  mt-2">
                                    <input name="imagen"
