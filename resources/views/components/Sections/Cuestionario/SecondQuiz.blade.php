        ...
        <div class="px-[5%] md:px-0 md:max-w-lg 2xl:max-w-2xl  mx-auto text-center">
            ...
            <div class="space-x-4 w-full flex md:mt-8 2xl:mt-12">
                <button onclick="showCard(4)"
                    class="bg-white hover:bg-[#FF9900]  text-[#FF9900] hover:text-white font-semibold  px-6 rounded-[20px] md:text-[16.94px] 2xl:text-[20.94px] tracking-[0.01em] transition-colors w-[203px] md:h-[74px]  2xl:h-[94px] border-2 border-[#FF9900] duration-300">
                    Leve
                </button>
