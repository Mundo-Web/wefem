    ...
    <div class="bg-[#D9DE21] ">
        <div class="relative mx-auto  text-white py-10 px-6 flex flex-col items-center text-center " data-aos="fade-up"
            ...
            <img src="https://i.ibb.co/bj6rNvs7/1bc2a501a327fe55cf37f78fd57747ca.png" alt="Copa menstrual"
                class="absolute left-0 bottom-0 top-[100px] h-[900px] z-0 transform  scale-x-[-1] w-[450px] object-cover " />

            <!-- Contenido de la sección -->
            <div class="max-w-6xl mx-auto relative z-10 grid grid-cols-2 gap-y-16 py-20 ">
                <!-- Primera fila -->
                <div class="flex flex-col items-center text-center">
                    <div class="text-[199px] leading-none  font-bold text-white mb-2"
                        style="text-shadow: 1.98px 3.96px 18.73px 0px #00000033;">+3K</div>
                    <div class="-rotate-2 text-white px-5 py-2 font-bold  text-[31.61px] bg-[#F750BD] ">
            ...
            <img src="https://i.ibb.co/4nHfPP5q/49f3389e94334976b46ba6a4d0aea0e8.png" alt="Disco menstrual"
                class="absolute right-0 bottom-0 top-[100px] h-[830px] z-0 transform   " />
        </div>
    </div>
</div>
