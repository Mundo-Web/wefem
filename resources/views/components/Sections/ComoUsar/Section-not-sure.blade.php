 <section class="py-10 px-[5%] mx-auto font-font-general bg-white my-4" data-aos="fade-up" data-aos-duration="1000"
     ...
     <div class="mx-auto flex justify-center items-center  mt-4 gap-8">
         ...
         <div class="w-[475px] text-[#333333]">
             ...
             <h3 class="text-[54.38px] leading-[60.78px] font-bold">¿Te gustaría primero probar el disco?</h3>
             <p class="text-[29px] leading-[36px] mt-2 ">Disco
             ...
             <p class="text-[49.33px] leading-[62.31px] tracking-[-0.01em] font-bold text-[#FC58BE]">$/. 49.90</p>
             <p class="text-[24.84px] leading-[31.37px] text-[#B4B4B4]"><del>Antes $/. 99.90</del></p>
