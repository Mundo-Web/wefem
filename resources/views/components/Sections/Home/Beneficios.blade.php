            ...
            <div class="max-w-2xl mx-auto relative z-10">
                ...
                <div class="flex justify-center gap-10 mt-4">
                    <div class="w-1/2 flex flex-col items-center justify-center">
                        <span
                            class="md:text-[28.79px] 2xl:text-[32.79px] 2xl:leading-[53.52px] font-bold text-[#E7FF57]">Reemplaza</span>
                        <h3 class=" md:text-[136.9px] 2xl:text-[146.9px] tracking-[13.12px] md:leading-[120.9px] 2xl:leading-[146.9px]  font-bebas count"
                            data-count="600">0
                        </h3>
                        <p class="md:text-[20.14px] 2xl:text-[24.14px] 2xl:leading-[62.3px]">Toallas higiénicas</p>
                    </div>
                    <div class="w-1/2 flex flex-col items-center justify-center">
                        <span
                            class="md:text-[28.79px] 2xl:text-[32.79px] 2xl:leading-[53.52px] font-bold text-[#E7FF57]">Ahorra</span>
                        <h3 class="md:text-[136.9px] 2xl:text-[146.9px] tracking-[13.12px] md:leading-[120.9px] 2xl:leading-[146.9px] font-bebas count"
                            data-count="900">0
                        </h3>
                        <p class="md:text-[20.14px] 2xl:text-[24.14px] 2xl:leading-[62.3px]">Soles Aprox</p>
                    </div>
                </div>
            </div>
            <img src="https://i.ibb.co/bj6rNvs7/1bc2a501a327fe55cf37f78fd57747ca.png" alt="Copa menstrual"
                class="absolute -left-4 md:-left-36 2xl:-left-16 bottom-0 top-[-100px] h-[540px] z-0 transform scale-x-[-1]" />
            <img src="https://i.ibb.co/4nHfPP5q/49f3389e94334976b46ba6a4d0aea0e8.png" alt="Disco menstrual"
                class="absolute right-0 md:-right-32 2xl:-right-12 bottom-0 top-[-60px] h-[470px] z-0 transform scale-x-[-1] -rotate-[8deg]" />
        </div>
    </div>
</div>
