     ...
     <div class="px-[5%] lg:max-w-7xl lg:px-0 mx-auto flex justify-between items-center gap-2" data-aos="fade-right"
         ...
         <div class="flex items-center w-max">
             <div class="bg-[#6745BA] rounded-full px-2 py-1">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="w-auto h-[43.16px]  fill-white">
                     <path
             ...
             <h2 class="text-[72.53px] leading-[72.53px] tracking-[0.01em] font-bebas"
