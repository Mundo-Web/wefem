...
<section class="bg-white text-black py-16 ">
    ...
    <div class="max-w-6xl mx-auto text-center mb-12">
        ...
        <a href="https://instagram.com/wefem.pe"
            class="inline-flex items-center text-[#EF62BA] hover:opacity-90 transition-opacity text-3xl">
                ...
                <div class="relative group overflow-hidden ">
                    ...
                    <div class="absolute top-2 right-2 cursor-pointer">
                        <svg class="w-6 h-6 text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path
                                d="M15 3h4a2 2 0 012 2v4M9 21H5a2 2 0 01-2-2v-4m0-4V5a2 2 0 012-2h4m8 16v4a2 2 0 01-2 2h-4"
