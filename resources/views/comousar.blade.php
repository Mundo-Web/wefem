...
<body class="bg-white relative">
    ...
    <main class="">
        ...
        <div class="py-12 text-white md:h-[300.68px] 2xl:h-[349.68px] flex items-center justify-center font-poppins"
            style="background: rgb(128,113,182);
background: linear-gradient(90deg, rgba(128,113,182,1) 0%, rgba(192,175,225,1) 100%);">
            <p
                class="px-[5%] md:max-w-5xl 2xl:max-w-7xl md:px-0 mx-auto md:text-[20.45px] 2xl:text-[26.45px] leading-[39.67px]">
